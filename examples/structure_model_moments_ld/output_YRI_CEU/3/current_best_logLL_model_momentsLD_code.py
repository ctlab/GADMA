...
def model_func(params, rho=None, theta=0.001):
    ...
    Y.integrate(tf=t2, nu=lambda t: [nu1_func(t), nu2_func(t)], m=migs, rho=rho, theta=theta)
    return Y
...
p0 = [0.19253666760867713, 0.7937710969017996, 0.001, 1.1785621678194411, 1.5563025157330725, 0.3184003807075412, 2.2557648495388047]
Nanc = 9752.162854602695
r_bins = [0.0, 1e-06, 2e-06, 5e-06, 1e-05, 2e-05, 5e-05, 0.0001, 0.0002, 0.0005, 0.001]
mu = 2.35e-08
