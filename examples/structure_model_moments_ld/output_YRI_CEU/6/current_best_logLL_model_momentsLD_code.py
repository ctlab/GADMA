...
def model_func(params, rho=None, theta=0.001):
    ...
    Y.integrate(tf=t2, nu=lambda t: [nu1_func(t), nu22], m=migs, rho=rho, theta=theta)
    return Y
...
p0 = [1.24911804558299, 0.043572431477641595, 0.06763418265890907, 4.066176453880442, 1.9532399632335489, 0.5505864065977518, 1.5395941843299437]
Nanc = 7012.136188587546
r_bins = [0.0, 1e-06, 2e-06, 5e-06, 1e-05, 2e-05, 5e-05, 0.0001, 0.0002, 0.0005, 0.001]
mu = 2.35e-08
