...
if __name__ == '__main__':
	...
	parser.add_argument(
                '-b', '--boots', metavar="<dir>", required=True, help='Directory where bootstraped data is located.')
	parser.add_argument(
	...
	parser.add_argument(
                '-p', '--params', metavar="<filename>", type=str, default=None, help='Filename with parameters. This parameters are presented in -d/--dem_model option. It should be valid python file.')
	...
	print(str(len(all_boot)) + ' bootstraped data found.')
